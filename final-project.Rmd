...
pacman::p_load(data.table, dplyr, tidyverse, xtable, ggplot2, glmnet, randomForest)
```
...
data.lm.train <- select(data.lm.train, -price_binary)
...
data.lm.test <- select(data.lm.test, -price_binary)
...
data.log.train <- select(data.log.train, -price)
