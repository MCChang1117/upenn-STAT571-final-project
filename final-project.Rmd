...
pacman::p_load(data.table, dplyr, tidyverse, xtable, ggplot2, randomForest)
```
...
```{r, echo = FALSE, reduce, warning = FALSE, message = FALSE, results='hide'}
...
```{r tune rf hyperparameter, warning = FALSE, message = FALSE, results='asis'}
...
for (p in 1:10){
  ...
  rf.error.p[p] <- fit.rf.train$err.rate[150]
}
