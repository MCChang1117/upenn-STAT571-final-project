...
pacman::p_load(data.table, dplyr, tidyverse, xtable, ggplot2, randomForest, tfdatasets, keras, car)
```
...
```{r lasso, echo = FALSE, warning = FALSE, message = FALSE, results='hide'}
library(glmnet)
dim(data.lm.train)
...
```{r training 2, echo = FALSE, warning = FALSE, message = FALSE, results='asis'}
